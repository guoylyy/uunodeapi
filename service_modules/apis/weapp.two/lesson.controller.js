...
pub.getLessonList = (req, res) => {
  return schemaValidator
    ...
    .then(queryParam => {
      queryParam.weappType = enumModel.weappTypeEnum.BIYI.key
...
pub.getBanners = (req, res) => {
  return schemaValidator
    ...
    .then(() => {
      return bannerService.queryBannerList(bannerBizTypeEnum.LESSON.key, enumModel.weappTypeEnum.BIYI.key)
    })
    .then(result => {
